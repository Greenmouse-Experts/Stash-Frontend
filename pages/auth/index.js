        ...
        <div className="lg:bg-secondary min-h-screen font-primary" >
            <div className="flex lg:pt-16 text-sm h-screen items-center justify-center">
                <div className="lg:w-4/12 rounded shadow bg-white w-11/12 p-6 pb-8">
                    <Link href='/'>
                        <Image src='https://res.cloudinary.com/greenmouse-tech/image/upload/v1679573442/Stash/Group_48096160_2_sax9kt.png' alt='logo' width={300} height={300} className='w-36 lg:w-48 pr-6 mx-auto'/>
                    </Link>
                    <div className='mt-4'>
                        <p className='fw-500 text-center lg:text-xl mb-12'>Login to your account </p>
                        <form>
                            <div>
                                <div className='bg-input p-2 flex items-center rounded fs-600'>
                                    ...
                                    <input type='text' placeholder='Email' className='p-1 w-full focus:bg-input bg-input placeholder-gray-400 outline-none'/>
                                </div>
                            </div>
                            <div className='mt-6'>
                                <div className='bg-input p-2 flex items-center rounded fs-600'>
                                ...
                                <p className='mt-4 text-end'>
                                    <Link href='/auth/forget' className='fw-500 '>Forgot password?</Link>
                                </p>
                            </div>
                            <div className='mt-12'>
