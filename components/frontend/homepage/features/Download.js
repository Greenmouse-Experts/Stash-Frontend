    ...
    <div className='bg-secondary'>
        <div className='h-01 grid place-content-center'>
            <div className='text-center'>
                <p className='fw-600 text-4xl text-white'>A digital bank made just for you</p>
                <p className='text-gray-100 lg:w-8/12 mx-auto mt-6 text-center'>Open a new Stash account from your phone or computer and follow the simple on-screen steps to register for an account in minutes.</p>
