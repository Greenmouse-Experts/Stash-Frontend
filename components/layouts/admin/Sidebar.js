    ...
    <div className="left-0 fixed index-30 h-screen bg-secondary">
      ...
      >
        ...
        >
          ...
          <MenuItem component={<Link href="/admin/save" />} icon={<BsBank />}>
            Savings
          </MenuItem>
          <MenuItem
          ...
          >
            ...
            <MenuItem component={<Link href="/admin/settings/customers" />}>
              Manage Clients
            </MenuItem>
            <MenuItem component={<Link href="/admin/settings/logs" />}>
              Logs
            </MenuItem>
          </SubMenu>
          <MenuItem
